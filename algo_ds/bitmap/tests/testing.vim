...
set helplang=en
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/rigel,~/.vim/bundle/YouCompleteMe,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim91,/usr/local/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/rigel/after,~/.vim/bundle/YouCompleteMe/after
set shiftwidth=0
...
argglobal
if bufexists(fnamemodify("../CHECKLIST", ":p")) | buffer ../CHECKLIST | else | edit ../CHECKLIST | endif
balt ../bitmap.hpp
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists(fnamemodify("../bitmap.hpp", ":p")) | buffer ../bitmap.hpp | else | edit ../bitmap.hpp | endif
balt ../CHECKLIST
setlocal keymap=
setlocal noarabic
setlocal noautoindent
