#ifndef FCP_ELEMENT_BUFFER
#define FCP_ELEMENT_BUFFER
...
class EBO : public BufferObject<T>
{
  public:
     ...
     * DYNAMIC_COPY.
     */
    EBO(const std::vector<T>& data, GLenum buffer_usage = GL_STATIC_DRAW): BufferObject(data, GL_ELEMENT_ARRAY_BUFFER)
    {
      this->bind();
